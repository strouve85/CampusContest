...
array_push($form_values_array, waRetrievePostParameter('lastname_field_0'));
$form_values_map['lastname_field_0'] = waRetrievePostParameter('lastname_field_0');
array_push($form_values_array, waRetrievePostParameter('mail_field_1'));
$form_values_map['mail_field_1'] = waRetrievePostParameter('mail_field_1');
$form_mail_reply_to=waRetrievePostParameter('mail_field_1');
array_push($form_values_array, waRetrievePostParameter('phone_field_2'));
$form_values_map['phone_field_2'] = waRetrievePostParameter('phone_field_2');
...
<?php
if ($lng == "fr")
$mail_content .= "Nom et prénom"."\n";
$mail_content .= $form_values_array[0]."\n";
$mail_content .= "\n";
if ($lng == "fr")
$mail_content .= "Votre email"."\n";
...
$mail_content .= "\n";
$lng=waRetrievePostParameter('lng');
$destinataire="contac@trouve.cf";
if ($lng == "fr")
$success_message="Le message à été envoyer avec succès.";
$res = waSendMail($destinataire,"Message du site trouve.cf",$mail_content,$reply_to);
